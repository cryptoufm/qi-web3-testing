...
var collectionAddr = "0xBd032F08e6CCcF634bB96b4f61D6e8E466387FA8"
var issuedQi = "0xB95d301239c4B16B025DFf6D1e82AE95D243e94e"



function registerQi(issuedQi, collectionAddr, wallet){
  ...
  contract.methods.registerIssuers(issuedQi, collectionAddr).send({from: wallet}, function(error, result){
      if(!error){
        console.log(result)
      }
      else {
...
registerNewCollection(issuedQi, collectionAddr, wallet);
