...
function emitQi(issuedQi, receiverAddr, wallet){
  ...
  contract.methods.registerReceiver(issuedQi, receiverAddr).send({from: wallet}, function(error, result){
      if(!error){
        console.log(result)
      }
      else {
